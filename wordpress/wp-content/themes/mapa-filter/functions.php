...
function wp_create_event() {
  ...
  //if(isset($_POST['serialize'])) {    //validations 
    ...
    // Add field value
    update_field( "tipo", $tema, $pid);
    update_field( "valor", $valor, $pid);

    update_post_meta($pid, 'local', array("address" => $titulo, "lat" => $lat, 'lng' => $long));
...
add_filter('acf/settings/google_api_key', function () {
  return 'AIzaSyCsQdSlW4vj5RvXp2_pLnv1s1ErfxjM5_o';
});
